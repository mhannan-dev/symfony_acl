    ...
    public function load(ObjectManager $manager): void
    {
        $contentTypes = [
            ContentTypeFixtures::CONTENT_TYPE_USER => [
                'add' => self::PERMISSION_USER_ADD,
                'change' => self::PERMISSION_USER_CHANGE,
                'delete' => self::PERMISSION_USER_DELETE,
                'view' => self::PERMISSION_USER_VIEW,
            ],
            ContentTypeFixtures::CONTENT_TYPE_GROUP => [
                'add' => self::PERMISSION_GROUP_ADD,
                'change' => self::PERMISSION_GROUP_CHANGE,
                'delete' => self::PERMISSION_GROUP_DELETE,
                'view' => self::PERMISSION_GROUP_VIEW,
            ],
            ContentTypeFixtures::CONTENT_TYPE_PERMISSION => [
                'add' => self::PERMISSION_PERMISSION_ADD,
                'change' => self::PERMISSION_PERMISSION_CHANGE,
                'delete' => self::PERMISSION_PERMISSION_DELETE,
                'view' => self::PERMISSION_PERMISSION_VIEW,
            ],
            ContentTypeFixtures::CONTENT_TYPE_CONTENT_TYPE => [
                'add' => self::PERMISSION_CONTENT_TYPE_ADD,
                'change' => self::PERMISSION_CONTENT_TYPE_CHANGE,
                'delete' => self::PERMISSION_CONTENT_TYPE_DELETE,
                'view' => self::PERMISSION_CONTENT_TYPE_VIEW,
            ],
            ContentTypeFixtures::CONTENT_TYPE_ACTIVITY_LOG => [
                'add' => self::PERMISSION_ACTIVITY_LOG_ADD,
                'change' => self::PERMISSION_ACTIVITY_LOG_CHANGE,
                'delete' => self::PERMISSION_ACTIVITY_LOG_DELETE,
                'view' => self::PERMISSION_ACTIVITY_LOG_VIEW,
            ],
        ];
