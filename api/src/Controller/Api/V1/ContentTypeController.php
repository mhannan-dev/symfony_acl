...
class ContentTypeController extends AbstractController
{
    ...
    #[Route('/new', name: 'api_v1_content_types_new_form', methods: ['GET'])]
    public function new(): JsonResponse
    {
        return $this->json(['contentType' => null]);
    }

    #[Route('/save', name: 'api_v1_content_types_save', methods: ['POST'])]
    ...
    #[Route('/{id}/edit', name: 'api_v1_content_types_edit_form', methods: ['GET'])]
    ...
    #[Route('/{id}/delete', name: 'api_v1_content_types_delete', methods: ['DELETE'])]
